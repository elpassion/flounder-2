      ...
      >
        ...
        <div
          className={classNames(
            ...
            {
              "border-neutral-300 group-hover:bg-accent-50 peer-checked:border-accent-500 peer-checked:bg-accent-50 peer-checked:text-accent-500 peer-focus:border-accent-500 peer-focus:ring peer-focus:ring-accent-50":
                !disabled,
