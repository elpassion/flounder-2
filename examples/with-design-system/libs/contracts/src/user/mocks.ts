...
import { TGetCognitoUser } from './get-cognito-user.schema.type';
...
export const firstUser: TGetCognitoUser = {
...
export const secondUser: TGetCognitoUser = {
...
export const exampleUser: TExtendedUser = {
...
export const editedExampleUser: TExtendedUser = {
  cognito_id: 'exampleId',
  email: 'examplemail@mail.com',
  first_name: 'Harry',
  last_name: 'Novack',
