...
describe('TypeORM paginate', () => {
  ...
  beforeAll(async () => {
    ...
    catToys = await catToyRepo.save([
      catToyRepo.create({
        name: 'Fuzzy Thing',
        cat: cats[0],
        size: { height: 10, width: 10, length: 10 },
      }),
      catToyRepo.create({
        name: 'Stuffed Mouse',
        cat: cats[0],
      ...
      catToyRepo.create({
        name: 'String',
        cat: cats[1],
        size: { height: 1, width: 1, length: 50 },
      }),
    ]);
  ...
  it('should return an instance of Paginated', async () => {
    const config: TypeORMPaginateConfig<CatEntity> = {
      sortableColumns: ['id'],
    ...
    const result = await adapter.paginate<CatEntity>(query, catRepo, config);
  ...
  it('should accept a query builder', async () => {
    ...
    const result = await adapter.paginate<CatEntity>(
      query,
      queryBuilder,
      config
    );
  ...
  it('should return correct links for some results', async () => {
    ...
    const { links } = await adapter.paginate<CatEntity>(query, catRepo, config);
  ...
  it('should return result based on search term on many-to-one relation', async () => {
    const config: TypeORMPaginateConfig<CatToyEntity> = {
      relations: ['cat'],
    ...
    const result = await adapter.paginate<CatToyEntity>(
      query,
      catToyRepo,
      config
    );
    ...
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&search=Milo'
    );
  });
  ...
  it('should return result based on search term on one-to-many relation', async () => {
    ...
    delete toy2.cat;
    expect(result.data).toStrictEqual([
      Object.assign(clone(cats[0]), { toys: [toy, toy2] }),
    ]);
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&search=Mouse'
    );
  });

  it('should return result based on search term on one-to-one relation', async () => {
    const config: TypeORMPaginateConfig<CatHomeEntity> = {
      relations: ['cat'],
    ...
    const result = await adapter.paginate<CatHomeEntity>(
      query,
      catHomeRepo,
      config
    );
    ...
    expect(result.data).toStrictEqual(
      [catHomes[0], catHomes[1]].sort((a, b) => b.cat.id - a.cat.id)
    );
  ...
  it('should return result based on sort and search on many-to-one relation', async () => {
    ...
    expect(result.meta.search).toStrictEqual('Milo');
    expect(result.data).toStrictEqual(
      [catToys[0], catToys[1], catToys[2]].sort((a, b) => b.cat.id - a.cat.id)
    );
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=cat.id:DESC&search=Milo'
    );
  });
  ...
  it('should return result based on sort on one-to-many relation', async () => {
    ...
    delete toy2.cat;
    expect(result.data).toStrictEqual([
      Object.assign(clone(cats[0]), { toys: [toy2, toy1] }),
    ]);
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=toys.id:DESC&search=Mouse'
    );
  });
  ...
  it('should return result based on sort on one-to-one relation', async () => {
    ...
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&search=Garfield'
    );
  });
  ...
  it('should return result based on search term and searchBy columns', async () => {
    ...
    const expectedResultData = cats.filter(
      (cat: CatEntity) => cat.color === searchTerm
    );
  ...
  it('should return result based on filter on many-to-one relation', async () => {
    ...
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&filter.cat.name=$not:Milo'
    );
  });
  ...
  it('should return result based on filter on one-to-many relation', async () => {
    ...
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&filter.toys.name=$not:Stuffed Mouse'
    );
  });
  ...
  it('should return result based on filter on one-to-one relation', async () => {
    ...
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&filter.cat.name=$not:Garfield'
    );
  });
  ...
  it('should return result based on $in filter on one-to-one relation', async () => {
    ...
    expect(result.data).toStrictEqual([catHomes[0]]);
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&filter.cat.age=$in:4,6'
    );
  });
  ...
  it('should return result based on $btw filter on one-to-one relation', async () => {
    ...
    expect(result.data).toStrictEqual([catHomes[0]]);
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&filter.cat.age=$btw:6,10'
    );
  });
  ...
  it('should return result based on sort on embedded entity', async () => {
    ...
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=size.height:ASC&sortBy=size.length:ASC'
    );
  });
  ...
  it('should return result based on sort on embedded entity when other relations loaded', async () => {
    ...
    expect(result.data).toStrictEqual(orderedCats);
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=size.height:DESC&sortBy=size.length:DESC'
    );
  });
  ...
  it('should return result based on sort on embedded entity on one-to-one relation', async () => {
    ...
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=cat.size.height:DESC'
    );
  });
  ...
  it('should return result based on search on embedded entity', async () => {
    ...
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&search=10'
    );
  });
  ...
  it('should return result based on search term on embedded entity on many-to-one relation', async () => {
    ...
    expect(result.data).toStrictEqual([catToys[3]]);
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&search=30'
    );
  });
  ...
  it('should return result based on search term on embedded entity on one-to-many relation', async () => {
    ...
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&search=1'
    );
  });
  ...
  it('should return result based on sort and search on embedded many-to-one relation', async () => {
    ...
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=cat.size.height:DESC&search=1'
    );
  });
  ...
  it('should return result based on filter on embedded entity', async () => {
    ...
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&filter.size.height=$not:25'
    );
  });
  ...
  it('should return result based on filter on embedded on many-to-one relation', async () => {
    ...
    expect(result.data).toStrictEqual([catToys[3]]);
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&filter.cat.size.height=$not:25'
    );
  });
  ...
  it('should return result based on filter on embedded on one-to-many relation', async () => {
    ...
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&filter.toys.size.height=$eq:1'
    );
  });
  ...
  it('should return result based on filter on embedded on one-to-one relation', async () => {
    ...
    expect(result.data).toStrictEqual([catHomes[1]]);
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&filter.cat.size.height=$eq:30'
    );
  });
  ...
  it('should return result based on $in filter on embedded on one-to-one relation', async () => {
    ...
    expect(result.data).toStrictEqual([catHomes[1]]);
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&filter.cat.size.height=$in:10,30,35'
    );
  });
  ...
  it('should return result based on $btw filter on embedded on one-to-one relation', async () => {
    ...
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&filter.cat.size.height=$btw:18,33'
    );
  });
  ...
  it('should return result based on $ilike filter', async () => {
    ...
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&filter.name=$ilike:Garf'
    );
  });
  ...
  it('should return result based on filter and search term', async () => {
    ...
    expect(result.data).toStrictEqual([cats[3]]);
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&search=white&filter.id=$not:$in:1,2,5'
    );
  });
  ...
  it('should return result based on filter and where config', async () => {
    ...
    expect(result.data).toStrictEqual([cats[2], cats[3]]);
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&filter.id=$not:$in:1,2,5'
    );
  });
  ...
  it('should return result based on between range filter', async () => {
    ...
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&filter.age=$btw:4,5'
    );
  });
  ...
  it('should return result based on not null query on relation', async () => {
    ...
    const expectedResult = [0, 1].map((i) => {
      const ret = Object.assign(clone(cats[i]), {
        home: Object.assign(clone(catHomes[i])),
      });
      delete ret.home.cat;
      return ret;
    });
    ...
    expect(result.data).toStrictEqual(expectedResult);
    expect(result.links.current).toBe(
      '?page=1&limit=20&sortBy=id:ASC&filter.home.name=$not:$null'
    );
  });
  ...
  it('should throw an error when no sortableColumns', async () => {
    ...
    try {
      await adapter.paginate<CatEntity>(query, catRepo, config);
    } catch (err) {
  ...
  it.each([
    ...
    ({ operator, result }) => {
      expect(TypeORMAdapter.isOperator(operator)).toStrictEqual(result);
    }
  );
  ...
  it.each([
    ...
    ({ operator, name }) => {
      const func = TypeORMAdapter.OperatorSymbolToFunction().get(
  ...
  it.each([
    ...
    expect(TypeORMAdapter.getFilterTokens(string)).toStrictEqual(tokens);
  });
